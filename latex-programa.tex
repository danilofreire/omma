...
E-mail: $if(email)$$email$$else$TBD$endif$ & Web: $if(web)$\href{http://$web$}{$web$}$else$TBD$endif$\\
Horário de Atendimento: $if(officehours)$$officehours$$else$TBD$endif$  &  Horário das Aulas: $if(classhours)$$classhours$$else$TBD$endif$\\
Contato: $if(office)$$office$$else$TBD$endif$  & Classe: $if(classroom)$$classroom$$else$TBD$endif$\\
	&  \\
	\hline
	\end{tabular*}
